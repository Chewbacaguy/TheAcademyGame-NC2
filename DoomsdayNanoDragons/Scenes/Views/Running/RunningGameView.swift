...
struct RunningGameView: View {
    ...
    var body: some View {
        ZStack {
            ...
            SpriteView(scene: RunningGameScene(size: UIScreen.main.bounds.size, viewModel: viewModel, isAnimationStarted: $viewModel.isGameRunning, isGameOver: $viewModel.isGameOver))
